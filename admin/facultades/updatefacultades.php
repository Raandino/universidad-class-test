...
$idfacultad = $_GET['rn']; //idalumno
$nombrefacultad =$_GET['sn']; //nombre
...
<html>
    ...
    <body >
        ...
        <h1 id="h1conf">Actualizar Facultades</h1>
        <br>
    ...
    <form action="" method="GET" autocomplete="off"  >
        ...
        <input type="text" name="nombre"  maxlength="45" required value="<?php echo $nombrefacultad ?>">
        <br><br>
    ...
    <?php
        if($_GET['submit'])
        {
            ...
            $sql ="UPDATE facultades SET  nombre_facultad= '$nombre' WHERE idfacultad='$id' ";
